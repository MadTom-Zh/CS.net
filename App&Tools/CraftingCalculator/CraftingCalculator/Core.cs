...
namespace MadTomDev.App
{
    public class Core
    {
        ...
        internal List<Recipes.Recipe> FindRecipe_byProcessor(Guid processorId)
        {
        ...
        public WindowSelectThings? ShowSelectThingsWin(Window owner, bool isMultiSelect = false)
        {
