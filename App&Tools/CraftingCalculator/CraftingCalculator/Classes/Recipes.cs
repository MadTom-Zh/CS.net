    ...
    public class Recipes: ThingsBase
    {
        ...
        public void Reload()
        {
            ...
            Recipe? GetMain(string[] row)
            {
                ...
                {
                    if (double.TryParse(row[7], out testD))
                    {
                        result.period = testD;
                    }
                }
        ...
        private static void Simplify_List(ref List<Recipe.PIOItem> childList, List<Recipe.PIOItem> parentList)
        {
            ...
            for (int i = childList.Count - 1; i >= 0; --i)
            {
                ...
                p = copiedPList.Find(a => a.item != null && a.item.id == c.item.id);
                if (p == null)
                {
                    continue;
                }
        ...
        public class Recipe : ThingBase
        {
            ...
            public static void Inherite(ref List<PIOItem> childList, List<PIOItem> parentList)
            {
                ...
                {
                    c = childList[i];
                    p = copyList.Find(a => a.item?.id == c.item?.id);
                    if (p == null)
                    {
                        continue;
                    }
            ...
            public class PIOItem
            {
                ...
                public PIOItem(Things.Thing? item, Quantity? quantity, bool usingType = false, bool isExcluded = false)
                {
                    this.item = item;
                ...
                public string IOContent
                {
                    get
                    {
                        ...
                        if (item != null)
                        {
                            strBdr.Append(item.id.ToString());
                        }
                        strBdr.Append("|");
                ...
                public bool CheckValueEqual(object b)
                {
                    ...
                    if ((this.item != null && vb.item == null)
                        || (this.item == null && vb.item != null))
                    {
                        return false;
                    }
                    if ((this.item != null && vb.item != null)
                        && (this.item.id != vb.item.id))
                    {
                        return false;
                    }
            ...
            public class Quantity
            {
                ...
                public double ValueCurrent
                {
                    get
                    {
                        return valueFix + valueMinus + random.NextDouble() * (valuePlus - valueMinus);
                    }
                }
                public double ValueCurrentInGeneral
                {
                    get
                    {
                ...
                public double valueFix;
                public double valueMinus;
                public double valuePlus;
