...
namespace MadTomDev.App
{
    class Core : IDisposable
    {
        ...
        public BiliDMEngin20240731.MainWindow dmEngin;
        ...
        public Core(MainWindow mainWindow)
        {
            ...
            dmEngin = new BiliDMEngin20240731.MainWindow();
            dmEngin.Show();
        ...
        private static string setting_flag_replace_enabled = "replace_enabled";
        private static string setting_flag_filter_blackUser_enabled = "filter_blackUser_enabled";
        private static string setting_flag_filter_blackWord_enabled = "filter_blackWord_enabled";
        private static string setting_flag_filter_blackPin_enabled = "filter_blackPin_enabled";
        ...
        public bool basic_replace_enabled { get => GetCheckBoxIschecked(mainWindow.cb_enableReplace) == true; }
        public bool basic_filter_blackUser_enabled { get => GetCheckBoxIschecked(mainWindow.cb_enableFilter_blackUser) == true; }
        public bool basic_filter_blackWord_enabled { get => GetCheckBoxIschecked(mainWindow.cb_enableFilter_blackWords) == true; }
        public bool basic_filter_blackPin_enabled { get => GetCheckBoxIschecked(mainWindow.cb_enableFilter_blackPins) == true; }
        ...
        private void LoadSettingsToUI()
        {
            ...
            LoadSettingsToUI_loadCheckBox(setting_flag_replace_enabled, mainWindow.cb_enableReplace, true);
            LoadSettingsToUI_loadCheckBox(setting_flag_filter_blackUser_enabled, mainWindow.cb_enableFilter_blackUser, true);
            LoadSettingsToUI_loadCheckBox(setting_flag_filter_blackWord_enabled, mainWindow.cb_enableFilter_blackWords, true);
            LoadSettingsToUI_loadCheckBox(setting_flag_filter_blackPin_enabled, mainWindow.cb_enableFilter_blackPins, true);
        }
        ...
        public void SaveSettingsFromUI()
        {
            ...
            settings[setting_flag_replace_enabled]
                = basic_replace_enabled.ToString();
            settings[setting_flag_filter_blackUser_enabled]
                = basic_filter_blackUser_enabled.ToString();
            settings[setting_flag_filter_blackWord_enabled]
                = basic_filter_blackWord_enabled.ToString();
            settings[setting_flag_filter_blackPin_enabled]
                = basic_filter_blackPin_enabled.ToString();
        ...
        private void DmEngin_Connected(EnginInterface sender)
        {
        }
        private void DmEngin_Disconnected(EnginInterface sender, Exception err)
        {
        }
        ...
        private Queue<Bullet> beltBullets = new Queue<Bullet>();
        private Queue<Bullet> beltGifts = new Queue<Bullet>();

        ReaderWriterLockSlim bulletLock = new ReaderWriterLockSlim();
        private void BulletEnqueue(Bullet inBullet)
        {
            bulletLock.EnterWriteLock();
            try
            {
        ...
        private void GiftEnqueue(Bullet inBullet)
        {
            bulletLock.EnterWriteLock();
            try
            {
        ...
        private void DmEngin_NewBullet(EnginInterface sender, Bullet newBullet)
        {
            counter_bulletsAll++;
        ...
        {
            DmEngin_NewBullet(null, new Bullet(Bullet.BulletType.Msg)
            { userID = "-1", userName = tester, userMsg = msg, });
        }
        ...
        private void ProcessLoop()
        {
            Task.Run(() =>
            {
                ...
                while (beltBullets.Count > 0)
                {
                    ...
                    if (bullet.type == Bullet.BulletType.Gft)
                    {
                    ...
                    else
                    {
                        ...
                        if (string.IsNullOrEmpty(bullet.userID) == false
                            && basic_filter_blackUser_enabled
        ...
        private bool ProcessMsg(string oriText, out string? finalVoiceText, out string? failReason)
        {
            ...
            // check the 1st time
            if (basic_filter_blackWord_enabled && db.blackWords.Count > 0)
            {
            ...
            if (basic_replace_enabled && db.replacements.Count > 1)
            {
            ...
            if (basic_filter_blackPin_enabled && db.blackPins.Count > 0)
            {
                fragments = MultiVoice.TextMultiFragments.Detach(oriTextNoSmb);
        ...
        private void GiftCheckOut()
        {
            while (beltGifts.Count > 0)
            {
                ...
                List<Bullet> giftBullets = new List<Bullet>();
                bulletLock.EnterWriteLock();
                try
                {
                    while (beltGifts.Count > 0)
